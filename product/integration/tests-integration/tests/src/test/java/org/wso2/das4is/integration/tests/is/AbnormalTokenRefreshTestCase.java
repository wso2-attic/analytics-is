...
public class AbnormalTokenRefreshTestCase extends ISAnalyticsBaseTestCase {
    ...
    private final String REFRESH_TIME_DIFFERENCE_TABLE = "ORG_WSO2_IS_YTICS_ACCESSTOKENREFRESHTIMEDIFFERENCE";
    private final String LAST_ACCESS_TOKEN_REFRESH_TABLE = "ORG_WSO2_IS_TACCESSTOKENREFRESHEVENTTABLE";
    ...
    @Test(groups = "wso2.analytics.is", description = "Test if the Simulation data has been published"
    ...
    @Test(groups = "wso2.analytics.is", description = "Test Abnormal Access Token Refresh Alert Spark Script execution"
    ...
    @Test(groups = "wso2.analytics.is", description = "Test Abnormal Access Token Refresh Alert is not generated for " +
            "normal scenarios",
    ...
    public void testNormalTokenRefreshAlert() throws Exception {
        ...
        boolean abnormalTokenRefreshFound = isAlertReceived(0, "msg:Abnormal Access Token Refresh Detected " +
                "from User:carbon.super-home-is", 5, 2000);
        Assert.assertFalse(abnormalTokenRefreshFound, "Abnormal Token Refresh Alert is received!");
    }

    @Test(groups = "wso2.analytics.is", description = "Test Abnormal Access Token Refresh Alert",
